...
class DialogueBox extends FlxSpriteGroup
{
	...
	//	box = new FlxSprite(-40, 380);
		box = new FlxSprite(0, 0);
		box.frames = Paths.getSparrowAtlas('dialogue/DialogBox_R','r');
	...
	//	box.updateHitbox();
		...
		cg1 = new FlxSprite(0, 0).loadGraphic(Paths.image('dialogue/1','r'));
		cg1.setGraphicSize(Std.int(cg1.width * 0.67));
		cg1.updateHitbox();
		cg1.alpha = 0;
		add(cg1);

		cg2 = new FlxSprite(0, 0).loadGraphic(Paths.image('dialogue/2','r'));
		cg2.setGraphicSize(Std.int(cg2.width * 0.67));
		cg2.updateHitbox();
		cg2.alpha = 0;
		add(cg2);

		cg3 = new FlxSprite(0, 0).loadGraphic(Paths.image('dialogue/3','r'));
		cg3.setGraphicSize(Std.int(cg3.width * 0.67));
		cg3.updateHitbox();
		cg3.alpha = 0;
		add(cg3);

		cg4 = new FlxSprite(0, 0).loadGraphic(Paths.image('dialogue/4','r'));
		...
		portraitBF.frames = Paths.getSparrowAtlas('dialogue/portrait','r');
		...
		portraitGF.frames = Paths.getSparrowAtlas('dialogue/portrait','r');
		...
		portraitR.frames = Paths.getSparrowAtlas('dialogue/portrait','r');
		...
		portraitAce.frames = Paths.getSparrowAtlas('dialogue/portrait','r');
		...
		{
			swagDialogue.setFormat("assets/fonts/FZShangKJW.TTF", swagDialogue.size);
		}			
		else
		{
		...
		if (FlxG.save.data.language)	
		{
			skiptext.text = '按空格键跳过对话';
			skiptext.setFormat("assets/fonts/FZShangKJW.TTF", skiptext.size);
		}			
		else
		{
